...
/// <summary> Files, Paths, Names & IO common methods. (Last update: 2019-01-27) </summary>
public class FilePathName
{
    ...
    public string GetSaveDirectory(bool isTemporaryPath = false, string subFolder = "", bool createDirectoryIfNotExist = false)
    {
        ...
        {
            //Available path: Application.persistentDataPath, Application.temporaryCachePath, Application.dataPath, Application.streamingAssetsPath
